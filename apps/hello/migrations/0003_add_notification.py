...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_notification', (
            ...
            ('remote_addr_fwd', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ...
            ('raw_post', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'hello', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table(u'hello_notification')
